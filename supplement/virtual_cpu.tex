...
Each CPU can host up to 32 active virtual cores.
If additional cores are required after all 32 available are in use, the oldest active core is killed and replaced.
