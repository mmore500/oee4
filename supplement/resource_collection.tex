...
At every update within each tile, the simulation system broadcast all bits that were known to be set within that tile's kin group.
...
The source code controlling collective resource decay can be found at \url{https://github.com/mmore500/dishtiny/blob/prq49/include/dish2/services/CollectiveResourceDecayService.hpp}.
