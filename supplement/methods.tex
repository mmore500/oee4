...
Although meaningless, fitness would decrease if that message were blocked.
So, instead of simply discarding messages to test for a fitness effect, we reroute messages back to the sending cardinal processor rather than their intended recipient.
