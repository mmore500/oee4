...
Genotype complexity reaches a peak of 55 sites around stint 39, then levels out and decreases.
...
Phylogenetic analysis (Supplementary Figure \ref{fig:phylo_parsimony_tree}) suggests independent origins of the genotype fitness complexity in morph $d$ and morph $e$ --- the morph $d$ specimen from stint 14 is more closely related to the morph $b$ specimen from stint 13 than to the morph $e$ specimen from stint 15.
...
\unskip\footnote{%
Comparison is made against the stint 13 specimen rather than the immediately preceding stint 14 specimen, as morph $d$ at stint 14 falls on an offshoot lineage rather than the line of descent leading to morph $e$.
}
