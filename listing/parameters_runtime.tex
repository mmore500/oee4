...
Several parameters were further overridden on the command line by the evolution runscript (\url{https://github.com/mmore500/dishtiny/tree/prq49/slurm}), which set \texttt{N\_THREADS} to 4, \texttt{WEAK\_SCALING} to 1, and \texttt{N\_CELLS} to 3,600 --- giving the 14,400-cell population reported in the main text --- along with \texttt{RUN\_SECONDS} 10800 (the three-hour stint duration), \texttt{DATA\_DUMP} and \texttt{ARTIFACTS\_DUMP} 1, and per-stint values of \texttt{STINT}, \texttt{SERIES}, \texttt{TREATMENT}, and \texttt{GENESIS}.
...
\confdef{uint64\_t}{18446744073709551615}
