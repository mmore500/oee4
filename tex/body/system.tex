...
Within-group cell-cell interactions allow dynamic development and patterning processes \citep{goldsby2012task,moreno2021exploring}, while between-group cell-cell interactions build an environment of free-form interface competition --- creating feedback between evolved phenotypes and the environment (Figure \ref{fig:overview}g).

Cell behavior arises from activation of genome subprograms in tagged modules \citep{lalejini2018evolving}.
These modules selectively activate in response to incoming signals \citep{moreno2023matchmaker,holland2012signals} --- triggered by updates to the local environment, cell-cell messages, or expression of other modules (Figure \ref{fig:overview}f).
