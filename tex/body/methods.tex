...
groups that are too small do not receive this bonus, and  groups that are too large receive a penalty instead.
In order to ensure group turnover, we force groups to fragment into individual cells after 8,192 ($2^{13}$) updates.
This was estimated to be the number of updates that xxx....
