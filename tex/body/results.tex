...
That is, for each stint we performed competitions in the presence of case study lineage samples drawn from alternate timepoints --- rather than contemporary self-context.
...
Having found that biogenic selection locked in evolved complexity on the case study lineage, we next sought to assess whether this pattern generalized more broadly across replicates.
