...
Though somatic division of labor and economies of scale can produce some synergistic benefit \citep{corning2015synergistic,niklas2014evolutionary}, such adaptation --- being outweighted by structural overheads and accumulated metabolic impedimenta --- cannot explain complex multicellularity.
...
To compund this stochasticity, epistatic lock-in of arbitrary contingencies may act as a ratchet for complexity accumulation \citep{stoltzfus1999possibility,muozgmez2021constructive}.
...
An alternate adaptive explanation, however, may complement the neutralist framing: niche construction, where feedback from organisms' evolved traits shapes their own environmental context \citep{oldingsmee2003niche,odlingsmee1988niche}.
...
In the context of multicellularity, for instance, large body size may be selected as a means to resist predation \citep{niklas2014evolutionary}.
Indeed, such effects arise in experiments that introduce microbial predators to populations of naive prey \citep{boraas1998phagotrophy,yoshida2003rapid,herron2019denovo}.  % snowflake yeast --- adding protists https://link.springer.com/article/10.1186/s12052-015-0041-8
