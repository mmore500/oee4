...
Adaptation exploiting somatic division of labor and economies of scale \unskip\citep{corning2015synergistic,niklas2014evolutionary} alone cannot explain complex multicellularity as they recoup only a portion of metabolic costs.
...
In this framing, modest population sizes among multicells act as a ratchet to accumulate nearly-neutral redundancies and intermediates that, through establishment of arbitrary mechanistic dependencies, eventually become obligatory contingencies \citep{lynch2003origins,stoltzfus1999possibility,muozgmez2021constructive}.
...
An alternate adaptive explanation, however, may complement the neutralist framing: niche construction, where feedback from organisms' evolved traits shapes their own environmental context \citep{oldingsmee2003niche,odlingsmee1988niche,levins1985dialectical} --- whether by abiotic ecosystem engineering or direct creation of biogenic structure.
...
Leveraging a digital model system to study synthetic instances of multicell evolution \textit{in silico}, we observe spontaneous niche construction effects and test their relationship to genetic and phenotypic complexity.
Controlled by heritable genetic programs, these digital organisms act analogously to biological cells: replicating, mutating, competing, and thus evolving \unskip\citep{pennock2007models}.
Though artificial by nature, such models may tractably illuminate principles that generalize across evolving systems \citep{adami2000evolution,lenski2003evolutionary,zaman2014coevolution}.
Indeed, work among computer scientists to generalize ``open-ended'' creativity of evolution beyond biological life has sought inspiration from Evolutionary Transitions in Individuality (ETI) --- such as multicellularity --- and ecological niche construction \citep{dolson2019constructive,soros2014identifying,huizinga2018emergence,lehman2012beyond,nguyen2015,stanley2019open,packard2019overview,taylor2016open}.
