...
Adaptations exploiting somatic division of labor and economies of scale \unskip\citep{corning2015synergistic,niklas2014evolutionary} alone cannot fully explain complex multicellularity, as they recoup only a portion of metabolic costs.
Instead, some argue the intricacy of complex multicellular organisms to primarily reflect neutral diffusion from a lower complexity bound \citep{gould1990wonderful,TODO}.
In this framing, modest population sizes among multicells act as a ratchet to accumulate nearly-neutral mechanistic redundancies and superficialities that, through gradual accumulation of arbitrary mechanistic interdependencies, become locked in to essential functionality \citep{lynch2003origins,stoltzfus1999possibility,muozgmez2021constructive}.
...
An alternate means of adaptation, however, may complement the neutralist framing of complex multicellularity: niche construction, where feedback from organisms' evolved traits shapes their own environmental context \citep{oldingsmee2003niche,odlingsmee1988niche,levins1985dialectical}, through abiotic ecosystem engineering or direct creation of biogenic structure.
Where complex traits become advantaged by this new environmental context, they may be selected for \citep{taylor2004niche,waddington2008paradigm,laland2014niche,creanza2016cultural}.
In the case of multicellularity, the combinatorially vast space of available morphologies opens a Pandora's box of possible biotic interactions.
...
To date, however, the role of \textit{de novo} niche construction in promoting complexity during early multicell evolution remains to be tested experimentally \citep{goldsby2012task,goldsby2014evolutionary,bozdag2023denovo,ratcliff2012experimental,herron2016origins,kalambokidis2023multispecies}.
...
Leveraging a digital model system to study synthetic instances of multicell evolution \textit{in silico}, we observe spontaneous niche construction effects and test their relationship to genotype and phenotype complexity.
Model digital organisms, controlled by heritable genetic programs, act analogously to biological cells: replicating, mutating, competing, and thus evolving \unskip\citep{pennock2007models}.
Though artificial by nature, such models can tractably illuminate principles that generalize across diverse evolving systems both natural and artificial \citep{adami2000evolution,lenski2003evolutionary,zaman2014coevolution}.
For instance, principles of niche construction and Evolutionary Transitions in Individuality (ETI) --- such as multicellularity --- have heavily shaped work among computer scientists to generalize the ``open-ended'' creativity of evolution beyond biological life \citep{dolson2019constructive,soros2014identifying,huizinga2018emergence,lehman2012beyond,nguyen2015,stanley2019open,packard2019overview,taylor2016open}.
...
Following this, we examine the history of a case study lineage, showing how genetic complexity, phenotypic complexity, and morphological novelty can arise in early multicell evolution with much greater detail than previously possible.
Competition assays reveal the case study lineage became fit when abundant --- in other words, when serving as its own environmental context.
Using further competition assays, we next test whether the case study lineage's niche construction effects exerted selection on itself.
% unexpected that self-selection doesn't "freeze" evolution but that
We find it does, and evolutionary replay experiments further show these niche construction effects to maintain evolved complexity.
