...
Instead, some argue complex multicellular organisms to primarily reflect neutral diffusion from a lower complexity bound \citep{gould1990wonderful,TODO}.
...
An alternate means of adaptation, however, may complement the neutralist framing of complex multicellularity: niche construction, where feedback from organisms' evolved traits reshapes their own environmental context \citep{oldingsmee2003niche,odlingsmee1988niche,levins1985dialectical} through abiotic ecosystem engineering or direct creation of biogenic structure.
...
In the case of multicellularity, availability of combinatorially vast morphological possibilities opens a Pandora's box of potential biotic interactions.
...
Though artificial by nature, tractable digital models can nonetheless illuminate principles general to biological life and beyond \citep{adami2000evolution,lenski2003evolutionary,zaman2014coevolution}.
For instance, principles of niche construction and Evolutionary Transitions in Individuality (ETI) --- such as multicellularity --- have heavily shaped work among computer scientists to generalize the ``open-ended'' creativity of evolution in abiotic systems \citep{dolson2019constructive,soros2014identifying,huizinga2018emergence,lehman2012beyond,nguyen2015,stanley2019open,packard2019overview,taylor2016open}.
...
We next test whether this niche construction by our case study lineage exerted self-acting biotic selection.
