...
\caption{Introspective interface complexity, the number of states viewed within the cell itself that contribute to fitness. See Supplementary Figure \ref{fig:introspective_perturbation} for detail on the introspective states that contribute to fitness.}
