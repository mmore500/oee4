...
\caption{active site count complexity}
...
Active site count is the number of genome sites that contribute to phenotype, measured as the number of sites remaining after phenotype-neutral nopout (Section \ref{sec:phenotype_neutral_nopout}).
