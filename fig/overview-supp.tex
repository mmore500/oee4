...
Within each cell, behavior is directed by a collection of four virtual CPUs (``cardinal'' processors), each independently managing the cell's interactions with its N, S, E, or W neighbor cell (panel $e$).
