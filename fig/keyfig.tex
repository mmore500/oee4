...
\caption{%
\textbf{Overview of complexity, novelty, and adaptation across evolutionary history.}
\footnotesize
...
Bottom rows, ``$\Delta$ Fit Specimen'' and ``$\Delta$ Fit Population'' report fitness competitions between current checkpoint and preceding checkpoint.
...
Positive results indicate fitness gain; negative results indicate fitness loss.
