\begin{figure*}
\includegraphics[width=\linewidth]{binder-2025-08-24-keyfig/binder/teeplots/2025-08-24-keyfig/bbg=Without+viz=subplots+ext=.pdf}
\caption{%
...
Positive results indicate fitness gain; negative results indicate fitness loss;asterisks indicates significance ($p < 0.005$).
Fitness assays without biotic background shown; Supplementary Figure \ref{fig:keyfig-Contemporary} shows corresponding fitness results with contemporary biotic background.
}
\label{fig:keyfig}
\end{figure*}
