...
Compared against time-shifted effects, exact-contemporary background contexts produced greater fitness benefit (Mann-Whitney $U$ test, panel \ref{fig:timeshift:swarmplot}).
}
\label{fig:timeshift}
