...
\subcaption{
Genetic complexity across evolutionary history.
Genetic complexity is the count of genome sites with detectable fitness loss in knockout trials.
...
\begin{minipage}[t]{0.48\linewidth}
\subcaption{
Phenotypic complexity across evolutionary history.
Phenotype complexity is a count of distinct input/output interfaces between cell and environment/neighbors with detectable fitness loss in knockout trials.
Color coding corresponds to morphology categorization (Table \ref{tab:morph_by_stint}).
Arrows indicate estimated phylogenetic relationships.
}
