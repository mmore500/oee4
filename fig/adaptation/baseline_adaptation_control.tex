...
\caption{
\footnotesize
Number of competitions out of 20 won by first strain.
Ten competitions won corresponds to a perfectly neutral outcome.
Eighteen or more competitions won was considered to indicate a significant fitness difference between strains, as were outcomes of two or fewer competitions won.
These thresholds for significance are annotated with horizontal lines.
}
\end{subfigure}

\caption{
\textbf{Biotic background control adaptation experiments for selected stints.}
\footnotesize
