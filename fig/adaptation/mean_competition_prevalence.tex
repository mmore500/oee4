...
See Figure \ref{fig:mean_competition_prevalence_boxplot} for boxplot depiction of prevalence outcomes and Figure \ref{fig:mean_competitoin_prevalence_barplot} for bootstrapped confidence intervals on mean prevalence outcomes.
}
