...
Surprisingly, no correlation arose between genotype complexity and fitness or phenotype complexity and fitness.
Here, fitness was measured against cross-replicate comparators using 50/50 competition trials (Figure \ref{fig:fit:nobbg}).
Statistics are Pearson correlation and two-tail Wald tests.
}
