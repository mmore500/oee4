...
\rotatebox{90}{%
  \begin{tabular}{@{}c@{}}
    \bfseries\footnotesize morph\\[1pt]
    \bfseries\footnotesize\tikz[baseline=(morphjbadge.base)]{%
      \node[draw=black,very thick,fill=morphj,circle,inner sep=1pt,minimum size=1.1em,text=white] (morphjbadge) {$\boldsymbol{j}$};%
    }~life history\\[1pt]
    \scriptsize\textit{video animation:}~\href{https://hopth.us/hr}{\texttt{\scriptsize hopth.us/hr}}
  \end{tabular}%
}
\end{minipage}%
