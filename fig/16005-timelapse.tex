...
\begin{tcolorbox}[
  colframe=morphj,
  colback=morphj!8!white,
  colbacktitle=morphj!30!white,
  coltitle=black,
  fonttitle=\bfseries\footnotesize,
  title={%
    morph\ \raisebox{0pt}[0pt][0pt]{%
      \tikz[baseline=(morphjbadge.base)]{%
        \node[draw=black,very thick,fill=morphj,circle,inner sep=1pt,minimum size=1.3em,text=white] (morphjbadge) {$j$};%
      }%
    }\ life history\ (\href{https://hopth.us/hr}{\texttt{\footnotesize hopth.us/hr}})%
  },
  boxrule=0.8pt,
  arc=1pt,
  boxsep=3pt,
