...
\begin{minipage}[c]{0.055\linewidth}
\centering
\rotatebox{90}{%
  \begin{tabular}{@{}c@{}}
    \bfseries\footnotesize morph~\raisebox{0pt}[0pt][0pt]{%
      \rotatebox{-90}{%
        \tikz[baseline=(morphjbadge.base)]{%
          \node[draw=black,very thick,fill=morphj,circle,inner sep=1pt,minimum size=1.3em,text=white] (morphjbadge) {$\boldsymbol{j}$};%
        }%
      }%
    }~life history\\[3pt]
    \footnotesize(video animation:~\href{https://hopth.us/hr}{\texttt{\footnotesize hopth.us/hr}})
  \end{tabular}%
}
\end{minipage}%
