...
\par\centering
\lollipop{teal}{morph j}\lollipop{gray}{b}\lollipop{gray}{c}\lollipop{gray}{d}\lollipop{gray}{e}\lollipop{gray}{f}\lollipop{gray}{g}\lollipop{gray}{h}\lollipop{gray}{i}
...
\begin{tcolorbox}[
  ...
  boxrule=0.8pt,
  arc=1pt,
  left=2pt,right=2pt,top=1pt,bottom=2pt,boxsep=1pt,
  width=\linewidth,
]
...
Video animation: \href{https://hopth.us/hr}{\texttt{hopth.us/hr}}.
}
