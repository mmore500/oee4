...
\footnotesize
Plots report influence on focal strain competition assays due to presence versus absence of background strain.
...
Outcomes reported between $1$ (fitness gain; stint $n$ baseline driven extinct) and $-1$ (fitness loss; stint $n+1$ driven extinct), with near-zero values indicating comparable fitness.
