...
% holds the case-study side title so its box can be measured, letting the
% figure size its columns to the title instead of guessing; the panel
% column's width then sets the padding that frames the panels
