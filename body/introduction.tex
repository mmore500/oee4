...
Adaptations in somatic division of labor, somatic shielding, and economies of scale \unskip\citep{Saunders1976,corning2015synergistic,niklas2014evolutionary,Bell1997,willensdorfer2009evolution,koschwanez2013improved,gerhart1997cells,dawkins1976selfish} alone cannot fully explain complex multicellularity, as they recoup only a portion of metabolic costs.
Some argue that complex multicellularity largely reflects passive diffusion from a lower complexity bound \citep{Gould1988,gould1990wonderful,gould2011full,mcshea2010biology,Lehman2010,Miconi2008}.
...
Beyond constraints of metabolic viability, however, much of multicell evolution reflects biotic interaction with other organisms.
Such adaptation is the subject of niche construction theory, which examines how feedback from evolved organisms can shape selection \citep{odlingsmee2003niche,odlingsmee1988niche,levins1985dialectical,lewontin1983gene}.
% , through abiotic ecosystem engineering or direct production of biogenic structure.
Existing microbial evolution experiments show niche construction can shape adaptation and drive spontaneous diversification via nutrient crossfeeding or resource gradient establishment \citep{poltak2010ecological,traverse2012tangled,kirisits2005characterization,ellis2015character,rosenzweig1994microbial,treves1998repeated,koza2010environmental,callahan2014rapid}.
However, in addition to promoting diversity \citep{laland2017niche,brathen2015niche}, it is also hypothesized that niche construction can act as a selective ratchet for complex traits \citep{Waddington2008,laland2014niche,creanza2016cultural}.
...
For instance, body size has long been recognized as means to resist predation \citep{niklas2014evolutionary,stanley1973ecological,bonner1988evolution},
and experiments that introduce known microbial predators to populations of naive prey reproduce this effect \citep{boraas1998phagotrophy,yoshida2003rapid,herron2019denovo,pentz2015predator}.
Likewise, existing bacterial communities can shape traits evolved in nascent multicells \citep{quinterogalvis2018exploring}, as can dispersal competition between co-evolving multicell lineages \citep{rose2020metapopulation}.
...
Model digital organisms act analogously to biological cells: replicating, mutating, competing, and thus evolving \citep{pennock2007models}.
Though artificial in nature, the tractability of such digital models can nonetheless illuminate principles general to biological life \citep{adami2000evolution,lenski2003evolutionary,zaman2014coevolution}.
More broadly still, such work can also inform development of computational algorithms for ``open-ended'' creativity \citep{dolson2019constructive,soros2014identifying,huizinga2018emergence,lehman2012beyond,nguyen2015,stanley2019open,packard2019overview,taylor2016open,taylor2019evolutionary}).
...
We find adaptation under biotic selection, and evolutionary replay experiments reveal it acting to lock in evolved morphological patterning and evolved genotype complexity.
Finally, we test how niche construction and multicell complexity relate more generally, finding strong association across evolutionary replicates.
