...
Adaptations in somatic division of labor and economies of scale \unskip\citep{Saunders1976,corning2015synergistic,niklas2014evolutionary,Bell1997,willensdorfer2009evolution,koschwanez2013improved} alone cannot fully explain complex multicellularity, as they recoup only a portion of metabolic costs; similarly, for explanations of environmental shielding \citep{gerhart1997cells,dawkins1976selfish}.
Instead, some argue complex multicellular organisms to largely reflect passive diffusion from a lower complexity bound \citep{Gould1988,gould1990wonderful,gould2011full,mcshea2010biology,Lehman2010,Miconi2008}.
Under this neutralist framing, modest multicell population sizes act as a ratchet to accumulate mechanistic interdependencies that become locked into essential functionality \citep{lynch2003origins,Smith1972,stoltzfus1999possibility,muozgmez2021constructive,Liard2020}.
...
In nature, however, numerous extrinsic ecological and environmental factors also select on multicells.
An alternate framing of adaptation, thus, may complement neutralist explanations: niche construction --- where adaptation tracks biogenic changes in environmental context driven by feedback from evolved traits \citep{odlingsmee2003niche,odlingsmee1988niche,levins1985dialectical,lewontin1983gene}.
% , through abiotic ecosystem engineering or direct production of biogenic structure.
Existing evolution experiments clearly demonstrate spontaneous diversification by niche construction and partitioning \citep{poltak2010ecological,traverse2012tangled,kirisits2005characterization,ellis2015character,rosenzweig1994microbial,treves1998repeated}.
However, in addition to promoting diversity \citep{laland2017niche,brathen2015niche}, it is also hypothesized that biogenic environmental context can additionally act as a selective ratchet for complex traits \citep{Waddington2008,laland2014niche,creanza2016cultural}.
Likewise, biotic selection rules in agent-based models of evolution can also promote complex traits \citep{taylor2004niche,zaman2014coevolution,TODO}.
...
For instance, it has long been recognized that body size may provide means to resist predation \citep{niklas2014evolutionary,stanley1973ecological,bonner1988evolution}.
...
Though artificial in nature, such tractable digital models can nonetheless illuminate principles general to biological life --- and beyond \citep{adami2000evolution,lenski2003evolutionary,zaman2014coevolution}.
For instance, correspondences to natural evolution have guided development of computational algorithms for ``open-ended'' creativity in artificial systems \citep{dolson2019constructive,soros2014identifying,huizinga2018emergence,lehman2012beyond,nguyen2015,stanley2019open,packard2019overview,taylor2016open,taylor2019evolutionary}.

The next section describes our experimental system, detailing how model digital organisms replicate, form multicells, and mediate multicell-multicell interactions.
Following this, we examine the history of a case study lineage: showing how functional complexity and morphological novelty can arise in early multicell evolution with much greater detail than previously possible.
Competition assays reveal that case study morphology became fit when abundant --- in other words, niche construction by shaping its own environmental context \citep{matthews2014under}.
We next test whether this constructed niche exerts self-acting biotic selection.
% unexpected that self-selection doesn't "freeze" evolution but that
We find it does, and evolutionary replay experiments further show biotic selection to lock in evolved complexity.
Finally, we conclude by examining niche construction and evolved complexity across many independent populations, finding broad associations between the two.
