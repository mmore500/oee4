...
Instead, some argue complex multicellular organisms to reflect diffusion from a lower complexity bound \citep{Gould1988,gould1990wonderful,gould2011full,mcshea2010biology,Lehman2010,Miconi2008}.
In this neutralist framing, modest multicell population sizes act as a ratchet to accumulate mechanistic interdependencies that become locked in to essential functionality \citep{lynch2003origins,Smith1972,stoltzfus1999possibility,muozgmez2021constructive}.
...
Observationally, it is known such biogenic environmental context can act as a selective ratchet to maintain complex traits \citep{taylor2004niche,Waddington2008,laland2014niche,creanza2016cultural}.
...
Though artificial by nature, such tractable digital models can nonetheless illuminate principles general to biological life --- and beyond \citep{adami2000evolution,lenski2003evolutionary,zaman2014coevolution}.
...
We next test whether this constructed niche exerts self-acting biogenic selection.
% unexpected that self-selection doesn't "freeze" evolution but that
We find it does, and evolutionary replay experiments further show biogenic selection to lock in evolved complexity.
