...
Beyond constraints of metabolic viability, however, much of multicell adaptation tracks biotic interaction with other organisms.
This observation underlies niche construction theory --- which emphasizes feedback from evolved traits on selection \citep{odlingsmee2003niche,odlingsmee1988niche,levins1985dialectical,lewontin1983gene}.
% , through abiotic ecosystem engineering or direct production of biogenic structure.
Existing evolution experiments clearly demonstrate niche construction in driving spontaneous diversification --- for instance, by giving rise to nutrient crossfeeding networks among microbes \citep{poltak2010ecological,traverse2012tangled,kirisits2005characterization,ellis2015character,rosenzweig1994microbial,treves1998repeated}.
...
Under this framing, evolved traits may themselves select for complex features.
Existing work imposing explicit biotic selection rules in agent-based simulation experiments indeed produce such effects \citep{taylor2004niche,zaman2014coevolution,TODO}.
