...
Some argue that complex multicellular organisms largely reflect passive diffusion from a lower complexity bound \citep{Gould1988,gould1990wonderful,gould2011full,mcshea2010biology,Lehman2010,Miconi2008}.
...
In nature, intrinsic contingencies and efficiency reflect only part of broader extrinsic ecological factors also selecting on multicells.
This observation has motivated niche construction theory --- which emphasizes adaptation in tracking biogenic environmental context shaped by feedback from evolved traits \citep{odlingsmee2003niche,odlingsmee1988niche,levins1985dialectical,lewontin1983gene}.
...
Indeed, explicit biotic selection rules in agent-based simulation experiments can model such effects \citep{taylor2004niche,zaman2014coevolution,TODO}.
...
Following this, we examine a case study lineage to explore functional complexity and morphological novelty in early multicell evolution with much greater detail than previously possible.
...
Finally, we conclude by examining niche construction and evolved complexity across many independent populations, finding strong associations between the two.
