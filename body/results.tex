...
The case study lineage's cigar-like patterning first arose at transfer round 15 (morph $e$; \href{https://hopth.us/hr}{\texttt{hopth.us/hr}}) and
...
In other words, evolved traits acted specificially to ``lock in'' complexity, as opposed to simply cultivating generic conditions conducive to complexity (e.g., weakening selection).
...
Direct regression analysis ruther supports a direct relationship between self-adaptation and phenotype complexity (Supplementary Figure \ref{fig:reg-self-adaptation}).
