...
These results --- in conjunction with reciprocal experiments testing how the case study strain influenced its co-evolved counterpart (Supplementary Figure \ref{fig:external-bb-reciporical}) --- suggest a relationship of primarily commensalist interaction, rather than systematic cooperation or antagonism.
Notably, though, both strains tended overall to gain competitive advantage when tested with their co-evolved partner present (both $p < 10^{-4}$, exact Binomial tests; Supplementary Figure \ref{fig:external-bb-reciporical}).
