...
Among these high-complexity strains, 85\% were more fit in self-dense contexts, consistent with niche construction effects.
By contrast, only 54\% of lower-complexity strains exhibited such self-advantage (Fisher's exact test, $p = 0.005$, RR 1.58; Figure \ref{fig:general:pgcomplex-ecoself}).
