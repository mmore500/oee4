...
After cataloging morphological innovations, we next sought to characterize how structural and functional complexity developed across lineage history.
For this purpose, we conducted genetic knockout and phenotypic interference trials to quantify distinct adaptations (Section \ref{sec:measuringcomplexity}).
We traced these measures over evolutionary time, assaying them on isolates sampled from each transfer round (Figure \labelcref{fig:keyfig:gcomplexity,fig:keyfig:pcomplexity}, Supplementary Figure \ref{fig:complexity}).
