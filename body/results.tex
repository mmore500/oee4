...
Then, motivated by this case study, we test how biotic selection effects influence evolved complexity across evolutionary trials (Sections \ref{sec:biotic-selection-drives-multicell-complexity,sec:biotic-selection-acts-between-coevolving-lineages}).

\subsection{Case-study Lineage}
\label{sec:case-study-lineage}

To screen structural and functional complexity across evolutionary replicates, we tabulated distinct adaptations via genetic knockout and phenotypic interference trials (Figures \labelcref{fig:16005-timelapse:genotype-complexity,fig:16005-timelapse:phenotype-complexity}, Section \ref{sec:measuringcomplexity}).
These measures of genotype and phenotype complexity were traced across evolutionary histories at 10-transfer-round intervals ().
Among 40 replicates, an extreme outlier in these measures of genotype and phenotype complexity exhibited sustained values exceeding 3$\times$ IQR in both dimensions (blue highlight, Figure \ref{fig:16005-timelapse:mean-complexity}).
...
After cataloging morphological innovations, we next sought to characterize their relationship to development of structural and functional complexity across lineage history.
We thus conducted additional knockout and interference trials to assay genotype and phenotype complexity at each transfer round (Figure \labelcref{fig:keyfig:gcomplexity,fig:keyfig:pcomplexity}, Supplementary Figure \ref{fig:complexity}).
...
As a proxy for absolute fitness, we assembled a biotic ``measuring stick'' at each transfer round by drawing comparator samples from each of our 40 independent replicates, providing a comparator fitness measure between 0 (all losses) and 1 (all wins) (Figure \ref{fig:fit:comparator-fitness}).
...
Notably, both strains tended to exhibit higher comparator fitness when tested in the context of their co-evolved counterpart (both $p < 10^{-4}$, exact Binomial tests; Supplementary Figure \ref{fig:external-bb-reciporical}).
...
To our surprise, this self-context produced a strong, sustained fitness benefit from transfer round 15 onward (Mann-Whitney test, $p < 10^{-25}$; Cliff's $\delta=0.93$; Figure \ref{fig:fitness-background:distribution}).
...
Such selection, were it to have occured, could then be tested for connections to the case study strain's extreme sustained complexity.
...
Having found biotic selection stabilize evolved complexity on the case study lineage, we next sought to assess whether this pattern generalized more broadly across replicates.

To screen for analogous niche construction effects in other replicates, we tested self-adaptation --- whether a strain better outcompetes cross-replicate comparators in self-dense biotic contexts.
...
We also sought to directly test whether the most extreme complex multicellularity, such as the case study strain, tend to involve niche construction feedbacks.
...
Compared to lower-complexity strains, substantially more high-complexity strains were most fit in self-dense contexts, consistent with niche construction effects.
In contrast to 85\% of high-complexity strains, only 54\% of lower-complexity strains exhibited such self-advantage (Fisher's exact test, $p = 0.005$, RR 1.58; Figure \ref{fig:general:pgcomplex-ecoself}).
...
In addition to self-acting conspecific interactions, biological multicells encounter numerous heterospecific biotic influences from co-evolving lineages.
