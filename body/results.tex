...
\subsection{Biogenic Selection Drives Multicell Complexity}

\input{fig/general.tex}

Having detected biogenic selection for evolved complexity on the case study lineage, we next sought to assess whether this pattern generalized more broadly across replicates.
...
In other words, biogenic selection on complexity acts more generally beyond the specific mechanism arising in our case study.
% Thus, the mechanism of self-acting selection appears more general than one particular life history.

\subsection{Biogenic Selection Acts Between Co-evolving Lineages}
