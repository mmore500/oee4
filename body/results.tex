...
However, strong evidence for biotic selection arose in 6 cases, where fitness losses were actually fitness gains when measured in co-evolved context.
...
Such self-adaptation arose repeatedly, with robust evidence in at least 5/39 additional lineages (Mann-Whitney tests, $n=10$ paired observations, $\alpha = 0.05$; Supplementary Figures \labelcref{fig:external-bb-all,fig:general-supp:eco-vs-self}).
...
Further regression analysis confirms a direct relationship between self-adaptation and phenotype complexity (Supplementary Figure \ref{fig:reg-self-adaptation}).
