...
Among 40 replicates, an extreme outlier in genotype and phenotype complexity sustained an excess of 3$\times$ IQR in both dimensions (blue highlight, Figure \ref{fig:16005-timelapse:mean-complexity}).
...
Replays were compared between both a ``self context'' treatment and a ``co-evolved context'' treatment, with background context differing between intact case study lineage genomes and co-evolved lineage genomes (Figure \ref{fig:replay-background:design}).
...
Seeing that it did arise, we next tested whether self-adaptation influenced evolved complexity.
